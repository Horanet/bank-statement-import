...
class AccountBankStatementImportSheetMapping(models.Model):
    ...
    header_line_number = fields.Integer(
    ...
    debit_amount_column = fields.Char(
        string='Debit column',
        help='Debit amount of transaction in journal\'s currency',
    )
    credit_amount_column = fields.Char(
    ...
    balance_end_cell = fields.Char(
        string='Balance end cell',
        help='Cell of stetement balance end amount in journal\'s currency',
    )
